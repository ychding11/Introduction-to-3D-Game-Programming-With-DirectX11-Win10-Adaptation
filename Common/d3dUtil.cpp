	...
	std::vector<std::wstring>& filenames )
{
	...
	{
		HR(DirectX::CreateDDSTextureFromFileEx(device, filenames[i].c_str(), 0u/*maxsize*/, D3D11_USAGE_STAGING, 0,  D3D11_CPU_ACCESS_READ, 0 /*misc flag*/,false,(ID3D11Resource**)&srcTex[i], nullptr));
	}
